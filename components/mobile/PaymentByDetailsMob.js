            ...
            <div>
                ...
                <form > 
                    <div style={{marginBottom: '1em', position:'relative'}}>
                        ...
                        <input inputMode="decimal" placeholder="Сумма пополнения" className="inp3" type="text"></input>
...
Комиссия
            ...
            <div className="gzlqb7-9 foJCFM">
                ...
                <div className="type1">Комиссия</div>
                        ...
                        <div className="type2">10000 р.</div>
                        <br/>
                        <div className="type1">Максимальная сумма депозита </div>
                        <div className="type2">Нет верхнего лимита</div>
                        <div className="type1">Реквизиты счёта</div>
                        <div className="type2">Наименование организации: ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ "Пегас Кэпитал"</div>
                        <div className="type2">Юридический адрес: Россия обл Новосибирска, г. Новосибирск</div>
                        <div className="type2">ИНН: 5401999572</div>
                        <div className="type2">КПП: 540101001</div>
                        <div className="type2">БИК: 044525411</div>
                        <div className="type2">Банк: Филиал "ЦЕНТРАЛЬНЫЙ" Банка ВТБ ПАО Г. Москва</div>
                        <div className="type2">Корреспондентский счёт: 30101810145250000411</div>
                        <div className="type2">Расчётный счёт: 40702810900400000900</div>
