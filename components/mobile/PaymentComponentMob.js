import AdvCashMob from "../../components/mobile/AdvCashMob";
import Qiwi from "./../Qiwi";
import * as React from "react";
import ChooseIndexMob from './ChooseIndexMob'
...
constructor(props) {
    ...
    showComponent(componentName) {
      ...
      renderComponent(){
        ...
        case "AdvCash":
          return <AdvCashMob showComponent={this.showComponent} index={this.state.index}/>
        case "Qiwi":
          return <Qiwi />
        case "ChooseIndex":
          return <ChooseIndexMob showComponent={this.showComponent} index={this.index}/>
      }
    }
    render() {
