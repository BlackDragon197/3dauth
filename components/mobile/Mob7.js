        ...
        <Container> 
            ...
            <Columna>
                ...
                <div className="aims-p12">
                    <p>
                        В 2022 году компания Pegas Capital планирует запустить масштабное ICO, которое позволит всем нашим клиентам без дополнительных вложений получить электронную валюту, которую клиент сможет обменять на реальные деньги.
                    </p>
                    <p>
