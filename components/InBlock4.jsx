        ...
        <BLock id="invest">
            ...
            <Part1 src={'/block4/back1.png'} backsize={'72% 110%'} height='77vh'>
                <ContentZone1 height="27.593vh"  margin="15.556vh auto">
                    ...
                    <Textbox width="44.740vw">
                    Инвестируя 10 000 рублей, уже через 3 дня ваш депозит начинает приносить вам прибыль. В течение трех дней компания создаёт отдельный криптокошелёк для клиента, после чего команда трейдеров начинает обслуживание депозита. Проценты можно выводить, имея на балансе от 1 000 рублей начисленных процентов. В случае досрочного расторжения договора с компанией, возврат денежных средств можно заказать в любой момент, компания вернет его вам в течение 10 рабочих дней.
                    </Textbox>
            ...
            <Part1 src={'/block4/back2.png'} backsize={'85%'} height={'65vh'}>
                <ContentZone2 height="42vh">
                    <ContentZone1 height="24.593vh" margin="15.556vh 0 0 2.8vw">
                        ...
                        <Textbox width="44.740vw">
                        Инестируя 100 000 рублей уже через 3 дня депозит начинает приносить вам прибыль. В течение трех дней компания создаёт отдельный криптокошелёк и кабинет на бирже для клиента, после чего команда трейдеров начинает обслуживание депозита. Проценты можно выводить, имея на балансе от 10 000 рублей начисленных процентов. В случае досрочного расторжения договора с компанией возврат денежных средств можно заказать в любой момент компания вернет его вам в течение 14 рабочих дней.
                        </Textbox>
            ...
            <Part1 height="77vh">
                ...
                <ContentZone2 height="80vh">
                    <ContentZone1 height="100%" margin="0 0 0 2.8vw" style={{position:'relative', display:'block'}}>
                        ...
                        <Textbox width="44.740vw">
                        Инвестируя 1 000 000 рублей, уже на следующий день депозит начинает приносить вам прибыль. Компания закрепляет за клиентом личного менеджера, создаёт для клиента отдельный криптокошелёк, кабинет на бирже и формирует для клиента активы, которые хранятся в золотых слитках, после чего команда трейдеров начинает обслуживание депозита. Проценты можно выводить в любой удобный момент.
                        </Textbox><br/><br/>
                        <Textbox width="44.740vw">
                        В случае досрочного расторжения договора с компанией компания верне клиенту деннежные средства в течение 20 рабочих дней. В случае хранения депозита без снятия на протяжении 180 дней, клиент может оформить выплату в золотых слитках высшей пробы от партнёров компании по стоимости, которая на порядок ниже стоимости на рынке.
                        </Textbox><br/><br/>
                        <Textbox width="44.740vw">
                        Сдача слитков в банк позволит клиенту заработать дополнительно от 5 до 7% от вложенной суммы. Данный депозит позволяет клиенту участвовать в ICO, которое будет проведено компанией в 2022 году, клиент получит монеты, которые сможето бменять на реальные деньги.
                        </Textbox><br/><br/>
